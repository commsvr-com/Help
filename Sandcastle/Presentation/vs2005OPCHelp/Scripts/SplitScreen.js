	...
	function SplitScreen (nonScrollingRegionId, nonScrollingRegionId2, scrollingRegionId ) {

		// store references to the two regions
		this.nonScrollingRegion = document.getElementById(nonScrollingRegionId);
		this.nonScrollingRegion2 = document.getElementById(nonScrollingRegionId2);
	...
	SplitScreen.prototype.resize = function(e) {
		var height = document.body.clientHeight - this.nonScrollingRegion.offsetHeight - this.nonScrollingRegion2.offsetHeight;
		if (height > 0) {
