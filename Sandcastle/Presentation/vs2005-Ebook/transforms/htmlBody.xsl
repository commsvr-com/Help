<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" 
  ...
  <xsl:template name="lowerBodyStuff">
    ...
    <input type="hidden" id="hiddenScrollOffset"/>
    <div id="header2">
      <table cellpadding="2" cellspacing="0" width="100%" height="1px">
        <tr>
          <td class="nsrBottom">
  ...
  <xsl:template name="googleAnalitics">
    ...
    <script type="text/javascript">
      try {
      var pageTracker = _gat._getTracker("UA-6818165-1");
...
<xsl:template name="Sponsors">
      ...
      <tr>
       ...
       Sponsored by: <a href="http://www.commsvr.com/UAModelDesigner/html/1bf073fd-1de4-4558-8e90-76b4790258bb.htm"><img src="http://www.commsvr.com/UAModelDesigner/images/cas_logo_small.jpg" border="0"></img></a>
